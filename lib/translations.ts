  ...
  pt: {
    ...
    hero: {
      ...
      headline: {
        ...
        stack: "Next.js • Fastify • Python • PostgreSQL • Docker",
        focus: "OmniRoute • MCP Protocol • Agentes Autônomos",
      },
      subtitle: "Construo sistemas, pipelines e agentes que substituem processos inteiros — do backend corporativo ao ecossistema de IA com OmniRoute, Claude, GPT e Gemini orquestrados em um único gateway.",
  ...
  en: {
    ...
    hero: {
      ...
      headline: {
        role: "Software Engineer",
        stack: "Next.js • Fastify • Python • PostgreSQL • Docker",
        focus: "OmniRoute • MCP Protocol • Autonomous Agents",
      },
      subtitle: "I build systems, pipelines and agents that replace entire processes — from enterprise backend to an AI ecosystem with OmniRoute, Claude, GPT and Gemini orchestrated through a single gateway.",
