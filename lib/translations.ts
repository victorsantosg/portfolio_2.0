export const translations = {
  pt: {
    ...
    hero: {
      ...
      title1: "Sistemas modernos.",
      titleGradient: "Soluções que escalam.",
      title2: "",
      headline: {
        role: "Software Engineer | Full Stack & AI Systems",
        stack: "Next.js • Python • PostgreSQL • AI Agents • MCP",
        focus: "Sistemas Corporativos de Alta Performance & Gateways de IA",
      },
      subtitle: "Construo aplicações web completas, microsserviços de alto throughput e arquiteturas de IA resilientes — unindo Next.js, Fastify, Python, PostgreSQL e gateways agnósticos multi-provedor.",
      ctaPrimary: "Iniciar Projeto",
      ctaSecondary: "Ver Projetos",
      stats: {
        repos: "Repositórios Ativos",
        exp: "Anos de Experiência",
        automation: "Automações Entregues",
      },
    },
    stack: {
      title: "Tecnologias & Habilidades",
      subtitle: "Domínio em tecnologias modernas para entregar soluções completas, escaláveis e resilientes",
      categories: {
        aiModels: "Modelos de IA & Raciocínio",
        aiTools: "Gateways de IA & MCP",
        aiGateway: "IA & Gateways de Orquestração",
        models: "Modelos de IA (OpenAI, Claude, Gemini)",
        web: "Next.js & Frontend Moderno",
        backend: "Backend & Microsserviços",
        infra: "Infraestrutura & DevOps",
        automation: "Automação & Engenharia de Dados",
      },
    },
    about: {
      tagline: "<SobreMim />",
    ...
    quote: {
      ...
      reasons: [
        "IA integrada ao desenvolvimento — não como buzzword, mas como ferramenta real",
        "OmniRoute + MCP: infraestrutura agentic própria e funcional",
        "Entregas corporativas comprovadas (ERP, auditoria, analytics)",
        "Código cirúrgico com Karpathy Guidelines e Context Engineering",
        "Comunicação clara e suporte pós-lançamento",
      ],
    },
    footer: {
    ...
    aiEcosystem: {
      ...
      subtitle: "Não uso IA como copiloto — opero meu próprio gateway open source, orquestro 5+ modelos em paralelo e aplico técnicas de engenharia de contexto que poucos engenheiros conhecem.",
      proofTitle: "O que isso significa na prática:",
      proofs: [
        "OmniRoute local em :20128 — zero dependência de um único provedor, fallback automático em rate-limit HTTP 429",
        "Fusion Mode: 3+ modelos em paralelo, IA Juíz sintetiza o melhor — vai além do que qualquer chatbot oferece",
  ...
  en: {
    ...
    hero: {
      ...
      titleGradient: "Solutions that scale.",
      title2: "",
      headline: {
        role: "Software Engineer | Full Stack & AI Systems",
        stack: "Next.js • Python • PostgreSQL • AI Agents • MCP",
        focus: "High-Performance Enterprise Systems & AI Gateways",
      },
      subtitle: "I build end-to-end web applications, high-throughput microservices, and resilient AI architectures — using Next.js, Fastify, Python, PostgreSQL, and provider-agnostic multi-LLM gateways.",
      ctaPrimary: "Start Project",
      ctaSecondary: "View Projects",
      stats: {
        repos: "Active Repositories",
        exp: "Years of Experience",
        automation: "Automations Delivered",
      },
    },
    stack: {
      title: "Technologies & Skills",
      subtitle: "Proficiency in modern technologies to deliver complete, scalable, and resilient solutions",
      categories: {
        aiModels: "AI Models & Reasoning",
        aiTools: "AI Gateways & MCP",
        aiGateway: "AI & Orchestration Gateways",
        models: "AI Models (OpenAI, Claude, Gemini)",
        web: "Next.js & Modern Frontend",
    ...
    quote: {
      ...
      reasons: [
        "AI integrated into development — not as buzzword, but as a real tool",
        "OmniRoute + MCP: own agentic infrastructure that is live and functional",
        "Proven enterprise deliveries (ERP, audit, analytics)",
        "Surgical code with Karpathy Guidelines and Context Engineering",
    ...
    aiEcosystem: {
      tagline: "<AIEcosystem />",
      title: "My",
      titleGradient: "AI Ecosystem",
      subtitle: "I don't use AI as a copilot — I operate my own open source gateway, orchestrate 5+ models in parallel and apply context engineering techniques that few engineers know.",
      proofTitle: "What this means in practice:",
      proofs: [
        "OmniRoute local at :20128 — zero single-provider dependency, automatic fallback on HTTP 429 rate-limits",
        "Fusion Mode: 3+ models reason in parallel, AI Judge synthesizes the best — beyond what any chatbot offers",
        "Context Engineering: 65–75% fewer tokens, same precision — faster and cheaper projects",
        "Central Skills Server with 30+ MCP tools ready for any stack, database or problem",
      ],
    },
  },
}
